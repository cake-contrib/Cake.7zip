...
var searchModule = function() {
    ...
    a(
        {
            id:13,
            title:"OutputCommand",
            content:"OutputCommand",
            description:'',
            tags:''
        },
        {
            url:'/Cake.7zip/api/Cake.SevenZip.Commands/OutputCommand_1',
            title:"OutputCommand<T>",
            description:""
        }
    );
    a(
    ...
    a(
        ...
        {
            url:'/Cake.7zip/api/Cake.SevenZip.Commands/IHaveArgumentDirectories',
            title:"IHaveArgumentDirectories",
            description:""
        }
    );
    ...
    a(
        ...
        {
            url:'/Cake.7zip/api/Cake.SevenZip.Commands/IHaveArgumentArchive',
            title:"IHaveArgumentArchive",
            description:""
        }
    );
    a(
        ...
        {
            url:'/Cake.7zip/api/Cake.SevenZip.Commands/IHaveArgument',
            title:"IHaveArgument",
            description:""
        }
    );
    ...
    a(
        ...
        {
            url:'/Cake.7zip/api/Cake.SevenZip.Commands/IHaveArgumentFiles',
            title:"IHaveArgumentFiles",
            description:""
        }
    );
